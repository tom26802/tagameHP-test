                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12} sm={6} md={4}>
                            <SSpotContent>
                                ...
                                <StaticImage src='../../../images/info/event/kiyota.jpg'/>
                       ...
                       <Grid item xs={12} sm={6} md={4}>
                            <SSpotContent>
                                <div>停電の日</div>
                                <span>田瓶市全域</span><br/>
                                <StaticImage src='../../../images/info/event/teiden.jpg'/>
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12} sm={6} md={4}>
                            <SSpotContent>
                                ...
                                <StaticImage src='../../../images/info/event/sato.jpg'/>
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12} sm={6} md={4}>
                            <SSpotContent>
                                <div>まんだら灯籠祭り</div>
                                <span>沼田町島田</span><br/>
                                <StaticImage src='../../../images/info/event/tourou.jpg'/>
                        ...
                        <Grid item xs={6} sm={6} md={4}>
                            <SSpotContent>
                                <div>地蔵祭</div>
                                <span>田瓶市各地</span>
                                <StaticImage src='../../../images/info/event/jizosai.jpg'/>
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12} sm={6} md={4}>
                            <SSpotContent>
                                <div>千本菖蒲</div>
                                <span>山野辺村中矢</span><br/>
                                <StaticImage src='../../../images/info/event/ayame.jpg'/>
